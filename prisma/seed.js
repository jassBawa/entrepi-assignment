    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    lesson = _a.sent();
                    console.log("Lesson created: ".concat(lesson.id));
                    return [4 /*yield*/, prisma.reflectiveQuestion.createMany({
                            data: [
                                {
                                    lessonId: lesson.id,
                ...
                case 3:
                    questions = _a.sent();
                    console.log("".concat(questions.count, " reflective questions added."));
                    return [2 /*return*/];
            }
        });
    });
